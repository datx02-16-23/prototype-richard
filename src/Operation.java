...
public abstract class Operation {
	...
	/**
	 * A map containing the identifier of the filed (such as "destination" or "value") and the data they contained.
	 */
	 ...
	 * @param operationBody A map containing the identifier of the filed
